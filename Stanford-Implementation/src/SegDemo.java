...
public class SegDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final String basedir_local = "Stanford-Implementation/"+basedir;
        props.setProperty("sighanCorporaDict", basedir_local);
        // props.setProperty("NormalizationTable", "data/norm.simp.utf8");
        // props.setProperty("normTableEncoding", "UTF-8");
        // below is needed because CTBSegDocumentIteratorFactory accesses it
        props.setProperty("serDictionary", basedir_local + "/dict-chris6.ser.gz");
        if (args.length > 0) {
        ...
        segmenter.loadClassifierNoExceptions(basedir_local + "/ctb.gz", props);
